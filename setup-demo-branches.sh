...
echo "   git remote add origin git@github.com:hakjoon/portabletext-editor-bug-repro.git"
echo "   git push -u origin main"
echo "   git push -u origin working-3.3.6"
echo ""
echo "3. Your StackBlitz demo URLs will be:"
echo "   Broken:  https://stackblitz.com/github/hakjoon/portabletext-editor-bug-repro/tree/main"
echo "   Working: https://stackblitz.com/github/hakjoon/portabletext-editor-bug-repro/tree/working-3.3.6"
echo ""
echo "4. Your CodeSandbox demo URLs will be:"
echo "   Broken:  https://codesandbox.io/s/github/hakjoon/portabletext-editor-bug-repro/tree/main"
echo "   Working: https://codesandbox.io/s/github/hakjoon/portabletext-editor-bug-repro/tree/working-3.3.6"
echo ""
